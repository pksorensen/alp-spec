...
1. **Anyone can build a Runner** — connect your own runner/operator/agent stack to the agentics.dk server or any other ALP-compliant server
2. **Anyone can build a Server** — implement the ALP server API and route tasks to any Runner that speaks the protocol
...
- **Runner**: [pks-cli](https://github.com/pksorensen/pks-cli) — open source, C#
...
| Build a **Runner** | [spec/08-runner.md](spec/08-runner.md) |
